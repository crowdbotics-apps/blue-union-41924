"""
Django settings for blue_union_41924 project.
...
ROOT_URLCONF = 'blue_union_41924.urls'
...
WSGI_APPLICATION = 'blue_union_41924.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_union_41924 API",
    "DESCRIPTION": "API documentation for blue_union_41924 App",
    "VERSION": "v1",
}
